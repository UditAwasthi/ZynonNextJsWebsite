...
import {
    ...
    PlusSquare, User, Settings, Moon, Sun, LogOut, Menu, ChevronRight
} from "lucide-react";
...
export const Sidebar = () => {
  ...
  return (
        <div className="relative z-50"> {/* New Parent Wrapper to allow button overflow */}
            <aside
            ...
            >
                ...
                <button
                    ...
                    style={{ 
                        ...
                        // Ensures the button isn't clipped by the aside
                    }}
                >
                    <ChevronRight size={12} strokeWidth={3} />
                </button>

                {/* 3. The Content Wrapper (This handles the text clipping) */}
                    ...
                    <nav className="flex-1 space-y-1 mt-4 overflow-y-auto no-scrollbar">
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    {isActive && (
                                        <div className="absolute left-0 w-[2.5px] h-6 bg-black dark:bg-white" />
                                    )}
