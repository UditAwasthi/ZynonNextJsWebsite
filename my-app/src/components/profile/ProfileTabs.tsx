    ...
    <div className="mt-16 space-y-10">
        ...
        <div className="flex justify-center">
            <div className="flex p-1 bg-zinc-100 dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800">
                <button className="px-8 py-2 text-[10px] font-black uppercase tracking-[0.2em] bg-black dark:bg-white text-white dark:text-black flex items-center gap-3 transition-all">
                    <Grid size={14} strokeWidth={2.5}/> 
                    Artifacts
                </button>
                <button className="px-8 py-2 text-[10px] font-black uppercase tracking-[0.2em] text-zinc-500 hover:text-black dark:hover:text-white flex items-center gap-3 transition-all">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 pb-24">
            {/* Create New Slot - Industrial Style */}
            ...
            {[1, 2].map((i) => (
                <div key={i} className="relative aspect-square border border-zinc-300 dark:border-zinc-800 overflow-hidden bg-white dark:bg-black group">
                    {/* Dot Matrix Placeholder for empty/loading states */}
